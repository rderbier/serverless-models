...
huggingface_model = HuggingFaceModel(
    model_data="s3://hm-sentence-transformers/sentence-transformer-all-minilm-l6-v2.tar.gz",
    transformers_version='4.6',
    pytorch_version='1.7',
    py_version="py36",
    role="arn:aws:iam::262269367073:role/AmazonSageMaker-ExecutionRole")

serverless_config = ServerlessInferenceConfig(memory_size_in_mb=3072, max_concurrency=10)
