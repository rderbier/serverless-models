...
tokenizer = AutoTokenizer.from_pretrained("llmware/bling-tiny-llama-v0")
model = AutoModelForCausalLM.from_pretrained("llmware/bling-tiny-llama-v0")

# model.save_pretrained(modelPath)

input_ids = tokenizer.encode("<human>: "+text+"\n <bot>:summarize", max_length=512, truncation=True, return_tensors="pt")
